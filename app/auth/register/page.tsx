...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Redireccionar a la página principal después de un registro exitoso
    router.push("/");
  };

  return (
    <div className="flex flex-col md:flex-row-reverse w-full max-w-4xl overflow-hidden rounded-xl shadow-2xl shadow-purple-200 dark:shadow-purple-900">
      {/* Sección de imagen */}
			<div className="relative hidden md:block md:w-1/2 bg-purple-600">
				...
				<div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-white z-10">
						<h2 className="text-3xl font-bold mb-4">Únete a nosotros Humano</h2>
						<p className="text-center mb-6">Crea tu cuenta y conecta con la comunidad de mascotas</p>
						...
						<p className="text-sm opacity-80">Comparte las aventuras de tus mascotas</p>
				</div>
			</div>
