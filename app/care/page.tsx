    ...
    basic: [
        {
            ...
            content: 'Mantén una dieta equilibrada según la edad y tamaño de tu mascota. Establece horarios regulares de alimentación y proporciona agua fresca constantemente.',
            tips: [
            ...
            content: 'Mantén a tu mascota limpia y cepillada regularmente. La frecuencia del baño dependerá del tipo de mascota y su estilo de vida.',
            tips: [
    ...
    health: [
        {
            ...
            content: 'Programa chequeos regulares y mantén las vacunas al día. La prevención es clave para la salud de tu mascota.',
            tips: [
                'Vacunación según calendario',
                'Desparasitación regular',
                'Chequeos anuales preventivos'
            ]
        }, {
            title: 'Primeros Auxilios',
            icon: <Shield className="h-6 w-6" />,
            content: 'Ten un botiquín básico y conoce los signos de emergencia. Mantén a mano los contactos de emergencia veterinaria.',
            tips: [
                'Botiquín básico en casa',
                'Conoce signos de emergencia',
                'Ten plan de emergencia'
            ]
        }
    ],
    training: [
        {
            ...
            content: 'Establece rutinas de entrenamiento consistentes. El refuerzo positivo es clave para un entrenamiento exitoso.',
            tips: [
                'Comandos básicos diarios',
                'Usa premios como motivación',
                'Sé paciente y consistente'
            ]
        }, {
            title: 'Socialización',
            icon: <Heart className="h-6 w-6" />,
            content: 'Expón a tu mascota a diferentes situaciones, personas y otros animales de manera controlada y positiva.',
            tips: [
