...
export function PawBackground() {
    ...
    return (
        <div className="hidden xl:block fixed inset-0 -z-10 overflow-hidden pointer-events-none bg-white dark:bg-[#10061d] transition-colors duration-300 ease-in-out">
            <svg
            ...
            >
                {paws.map(( paw, index ) => (
                    <g
                        ...
                        className   = "text-purple-300 dark:text-purple-950 fill-current opacity-90 blur-[1px]"
                    >
