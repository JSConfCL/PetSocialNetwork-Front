...
const stories = [
  ...
  },
  {
    ...
    username: "BarkMaster",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2025/01/Portada-normal-13.jpg?w=550&h=309&crop=1",
    seen: false
  },
  {
    id: 3,
    ...
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/12/iStock-1393526817-e1734345968519.jpg?w=550&h=309&crop=1",
    seen: true
  },
  {
    id: 4,
    username: "PawsomeLife",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/04/26/662ba2f972891-e1732901106362.jpeg?w=550&h=309&crop=1",
    seen: false
  },
  {
    id: 5,
    username: "FurryTales",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/07/25/66a2694aa3243.jpeg?w=550&h=309&crop=1",
    seen: true
  },
  {
    id: 6,
    username: "SnugglePup",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/07/01/6682fb0cddf7f.jpeg?w=550&h=309&crop=1",
    seen: false
  },
  {
    id: 7,
    username: "MeowMingle",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/06/06/666176cfbd414.jpeg?w=550&h=309&crop=1",
    seen: false
  },
  {
    id: 8,
    username: "WoofWonders",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2022/10/12/63468d8aa12c2.jpeg?w=550&h=309&crop=1",
    seen: true
  },
  {
    id: 9,
    username: "PurrfectDay",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/05/29/66575645417d9.jpeg?w=550&h=309&crop=1",
    seen: false
  },
  {
    id: 10,
    username: "TailWagger",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/06/05/666023bbf3fad.jpeg?w=550&h=309&crop=1",
    seen: false
  },
  {
    id: 11,
    username: "FurBaby",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/03/25/660137587a661.jpeg?w=550&h=309&crop=1",
    seen: true
  },
  {
    id: 12,
    username: "PawPrints",
    imageUrl:
      "https://www.muyinteresante.com/wp-content/uploads/sites/5/2024/02/26/65dc9491d9506.jpeg?w=550&h=309&crop=1",
    seen: false
  }
];
  ...
  return (
    <div className="relative">
      <div className="mb-3 flex justify-center">
        <div className="h-1 w-full max-w-md overflow-hidden rounded-full bg-purple-200">
          <div
            className="h-full rounded-full bg-purple-400 transition-all duration-300 ease-out dark:bg-purple-600"
      ...
      >
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2" style={{ left: "0" }}>
          <Button
            variant="outline"
            size="icon"
            className={`rounded-full bg-white shadow-md transition-all duration-200 hover:bg-purple-100 dark:bg-purple-950 dark:hover:bg-purple-700 ${
